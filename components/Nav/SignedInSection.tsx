...
function SignedInSection({ imageUrl }: { imageUrl: string }) {
  ...
  return (
    <section className="flex gap-2">
        <button className="fixed bottom-10 right-6 sm:transparent-normal-btn sm:static">
          <span className="hidden sm:block">Create Prompt</span>
          <span className="block sm:hidden text-5xl text-white bg-indigo-500 rounded-full"><IoIosAdd /></span>
        </button>
